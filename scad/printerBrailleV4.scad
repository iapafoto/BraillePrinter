    ...
    difference() { 
      ...
      //      }
          ...
          //  translate([plC_dx+3,yMotor2+8]) rounded_square(12,12, 1,center=true);
            RoundedPolygon([[plC_dx-1,yMotor2+5], [21,yMotor1-xAxis1-8.5+20]], 2);;

        //    RoundedPolygon([[plC_dx+7,yMotor2+8], [plC_dx+7,yMotor1-xAxis1-8.5+22]], 2);;
        //    RoundedPolygon([[plC_dx-ep/2+1,yMotor2+8], [plC_dx+7,yMotor2+8]], 2);
...
module charriot(k, withFurniture) {
